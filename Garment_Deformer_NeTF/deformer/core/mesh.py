...
class Mesh:
    ...
    def edges(self):
        if self._edges is None:
            from deformer.utils.geometry import find_edges
    ...
    def connected_faces(self):
        if self._connected_faces is None:
            from deformer.utils.geometry import find_connected_faces
    ...
    def laplacian(self):
        if self._laplacian is None:
            from deformer.utils.geometry import compute_laplacian_uniform
